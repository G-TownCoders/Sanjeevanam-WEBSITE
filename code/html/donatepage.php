                        ...
                        <table class="table table-bordered">
                            ...
                            <?php
                             ...
                             if(isset($_POST['search']))
                             {
                               ...
                               //  $query = "SELECT * FROM `donateblood` WHERE CONCAT(`name`, `phone_no`, `email_id`, `state`,`city`,`blood_group`,`gender`) LIKE '%".$valueToSearch."%'";
                                // $search_result = filterTable(query: $query);
